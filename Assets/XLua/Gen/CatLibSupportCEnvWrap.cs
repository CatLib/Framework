...
namespace CSObjectWrap
{
    ...
    public class CatLibSupportCEnvWrap
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(typeof(CatLib.Support.CEnv), L, __CreateInstance, 2, 10, 0);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "ResourcesNoBuildPath", _g_get_ResourcesNoBuildPath);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ResourcesNoBuildPath(RealStatePtr L)
        {
            
            try {
			    LuaAPI.lua_pushstring(L, CatLib.Support.CEnv.ResourcesNoBuildPath);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
